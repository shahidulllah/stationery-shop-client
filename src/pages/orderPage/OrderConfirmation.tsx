...
const OrderConfirmation = () => {
  ...
  if (status === "loading") return <p className="text-center mt-10">Loading order details...</p>;
  if (status === "failed") return <p className="text-center mt-10 text-red-500">{error || "Failed to load order."}</p>;
